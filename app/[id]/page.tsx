    ...
    <main className="max-w-6xl mx-auto py-16 px-4 text-gray-200">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          >
            {/* View Live Button */}
            <button className="relative inline-flex h-12 overflow-hidden rounded-lg p-[1px] px-4 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:ring-offset-2 focus:ring-offset-[#000319] transform hover:-translate-y-1 transition duration-300">
